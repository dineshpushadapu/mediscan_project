...
@st.cache_data
def load_model():
    model = tf.keras.models.load_model(r'C:\Users\dines\Documents\ml\medi_scan_project\model.h5')
    return model
...
with st.sidebar:
    st.image(r'C:\Users\dines\Documents\ml\medi_scan_project\User_interface\eyejpg.jpg')
